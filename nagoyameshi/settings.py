...
ALLOWED_HOSTS = ['*.herokuapp.com', 'nagoyameshi-rk3942-2c70d196cf95.herokuapp.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # manage.pyと同じ階層のtemplatesフォルダがベースになる
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Stripeのパブリックキー
STRIPE_PUBLIC_KEY = os.getenv('stripe_APIkey')

# Stripeのシークレットキー
STRIPE_SECRET_KEY = os.getenv('stripe_SECkey')

# StripeのWebhookのシークレットキー
STRIPE_WEBHOOK_SECRET = os.getenv('stripe_WEBkey')
